### Lecture 6 - Demo for reading data from files and writing to files

##1  reading and writing functions in the built-in base R 
#=========================================================#
# reading from a comma separated file using read.table()
